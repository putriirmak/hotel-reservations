...
namespace Hotel_Ext.Controllers
{
    public class HotelsInfoesController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            HotelsInfo hotelsInfo = db.HotelInfo.Find(id);
            if (hotelsInfo == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "Id,hotelName,hotelAddress,hotelPhoneNumber")] HotelsInfo hotelsInfo)
        {
            if (ModelState.IsValid)
            {
                db.HotelInfo.Add(hotelsInfo);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,hotelName,hotelAddress,hotelPhoneNumber")] HotelsInfo hotelsInfo)
        {
            if (ModelState.IsValid)
            {
                db.Entry(hotelsInfo).State = EntityState.Modified;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(hotelsInfo);
        ...
        {
            HotelsInfo hotelsInfo = db.HotelInfo.Find(id);
            db.HotelInfo.Remove(hotelsInfo);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
